...
Partial Class ClientSelectionPage
    ...
    Private Sub InitializeComponent()
        ...
        ' ListBoxClients
        ' 
        ListBoxClients.BackColor = Color.YellowGreen
        ListBoxClients.Font = New Font("Elephant", 36F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ListBoxClients.ForeColor = Color.White
        ListBoxClients.FormattingEnabled = True
        ListBoxClients.ItemHeight = 77
        ListBoxClients.Location = New Point(181, 309)
        ListBoxClients.Name = "ListBoxClients"
        ListBoxClients.Size = New Size(1546, 466)
        ...
        BtnSelect.Location = New Point(1412, 876)
        ...
        BtnBack.Location = New Point(1589, 876)
